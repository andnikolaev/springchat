...
public class AdminService {
    ...
    public User banUser(User owner, long banedUserId, String ownerIp) {
        log.info("Start banUser() with id = {} from admin = {}", banedUserId, owner);
    ...
    public User deleteUser(User owner, long deletedUserId, String ownerIp) {
        log.info("Start deleteUser() with id ={} from admin = {}", deletedUserId, owner);
    ...
    public User updateUserStatus(User user, long id, int statusId, String ownerIp) {
        log.info("Start updateUserStatus() with id = {} from admin = {}", id, user);
        ...
        if (UserStatus.DELETED.equals(userStatus)) {
